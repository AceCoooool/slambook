...
// g2o edge
class EdgeProjectXYZRGBDPoseOnly : public g2o::BaseBinaryEdge<3, Eigen::Vector3d, g2o::VertexSBAPointXYZ,
    g2o::VertexSE3Expmap> {
public:
...
void bundleAdjustment(
    ...
    for (size_t i = 0; i < pts1.size(); i++) {
        ...
        edge->setId(index);
        edge->setVertex(0, dynamic_cast<g2o::VertexSBAPointXYZ*>(optimizer.vertex(index+1)));
